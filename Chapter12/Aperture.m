...
if (atype == 1 ) && ((ara <= 1) || (arb <= 1))%%
    fprintf(fid, '\n----------------------------------------------------------------');
    fprintf(fid, '\nNote: The aperture dimensions are too small electrically');
    fprintf(fid, '\n(a and/or b are smaller than the wavelength) to find HPBW of ');
    fprintf(fid, '\naperture with/without ground plane. The larger the apertures, ');
    fprintf(fid, '\nthe computed results will be more accurate.\n----------------------------------------------------------------');
    fprintf(fid, '\nOutput parameters:\n----------------------------------------------------------------');
    ...
    txt='Aperture is too small electrically; see comments in the results.';
    figure(1)
    text(-90,-75, txt,'FontSize',14,'Color','r')
        figure(2)
    text(-90,-75, txt,'FontSize',14,'Color','r')   
        figure(3)
    text(-100,-80, txt,'FontSize',14,'Color','r')   
        figure(4)
    text(-100,-80, txt,'FontSize',14,'Color','r')   
